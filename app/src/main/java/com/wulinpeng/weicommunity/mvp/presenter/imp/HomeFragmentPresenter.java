...
import com.wulinpeng.weicommunity.mvp.model.IStatusListModel;
import com.wulinpeng.weicommunity.mvp.model.IUserModel;
import com.wulinpeng.weicommunity.mvp.model.imp.StatusListModel;
import com.wulinpeng.weicommunity.mvp.model.imp.UserModel;
...
public class HomeFragmentPresenter implements IHomeFragmentPresenter {
    ...
    private IHomeFragmentView mRootView;

    private IUserModel mUserModel;

    private IStatusListModel mStatusModel;

    public HomeFragmentPresenter(IHomeFragmentView rootView) {
        mRootView = rootView;
